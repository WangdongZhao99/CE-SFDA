...
sys.path.append('./transduction_for_vlms')
    ...
    def train(self):
        ...
        for src_id, trg_id in self.dataset_configs.scenarios:
            for run_id in range(self.num_runs):
                ...
                # Train model
                non_adapted_model, last_adapted_model, best_adapted_model = self.train_model(src_id, trg_id)
...
if __name__ == "__main__":
    # ========  Experiments Name ================
    parser.add_argument('--save_dir', default='experiments_logs_0.3', type=str,
    ...
    parser.add_argument('--da_method', default='CESFDA', type=str, help='SHOT, AaD, MAPU,SCLM,TPDS,CESFDA')

    # ========= Select the DATASET ==============
    parser.add_argument('--data_path', default='D:/dataset', type=str, help='Path containing datase2t')
    parser.add_argument('--dataset', default='WISDM', type=str, help='Dataset of choice: (WISDM - HAR - HHAR -FD-)')
    ...
    parser.add_argument('--is_weighted', default=False, type=bool, help='cpu or cuda')
    parser.add_argument('--test_method', default='ensemble', type=str, help=['fixed', 'learnable', 'ensemble'])
